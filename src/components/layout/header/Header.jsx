    ...
    <header className="flex j-center" style={{backgroundColor: "#F2F2F2"}}>
      <div className="container flex j-between a-center">
        <div className={`${style.header_section} flex a-center j-between w-100`}>
          ...
          <ul className={`${style.menu} ${menu ? `flex a-center ${style.show_menu}` : `flex a-center`} `}>
            <span className={style.close_menu} onClick={() => setMenu(false)}>
          ...
          <div className="flex a-center">
            ...
            <span className={style.menu_btn} onClick={() => setMenu(!menu)}>
