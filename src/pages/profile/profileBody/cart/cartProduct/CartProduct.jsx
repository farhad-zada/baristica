    ...
    return (
        <div className={styles.product}>
            <div className="left flex a-center g20">
                ...
                <img src="" alt="" />
                <div>
                    <h2 className="f20 fw700 mt4 darkGrey_color">{product?.name ? product.name : 'COLOMBIA GESHA ANCESTRO'}</h2>
            ...
            <div className="right flex a-center g20">
                <span className='f24 fw400 darkGrey_color'>{product?.price ? product.price : '49'} ₼</span>
