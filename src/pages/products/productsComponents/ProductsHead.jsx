  ...
  return (
    <div className='flex j-between a-center'>
        <div className="left flex column g12">
            ...
            <h3 className='f16 fw400 darkGrey_color'>{lang ? productsPage[lang].subHeading : ''}</h3>
        </div>
        <div className={`${styles.right} flex a-center g12`}>
            {Phone}
            <div>
                <h2 className='f16 fw600 darkGrey_color'>{lang ? productsPage[lang].contactHeading : ''}</h2>
                <h3 className='f12 fw400 darkGrey_color'>{lang ? productsPage[lang].contactSubHeading : ''}</h3>
            </div>
        </div>
    </div>
  )
